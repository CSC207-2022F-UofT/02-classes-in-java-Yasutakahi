...
public class Silly implements Comparable<Silly>{
    ...
    /**
     * Creates a new Silly object.
     * This constructor takes in a two strings as an argument.
     *
     * @param par_1 a first string
     * @param par_2 a second string
     */
    public Silly(String par_1, String par_2) { this.name = par_1 + par_2; }
